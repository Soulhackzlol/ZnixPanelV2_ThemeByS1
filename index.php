...
">Dashboard</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background-color: rgb(38,38,38);margin: -1px;margin-top: 69px;margin-right: 57px;margin-left: -1px;border: 1px solid #777777;border-radius: 5px;border-left: 3px solid #77777777;">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars" style="margin-right: 0px;margin-left: 0px;"></i></button><i class="fas fa-tachometer-alt" style="color: rgb(236,239,255);"></i>
                        <h3 class="text-dark mb-0" style="font-family: ABeeZee, sans-serif;font-size: 16px;visibility: show;margin-left: 10px;">DashBoard</h3>
    ...
    <footer class="bg-white sticky-footer" style="position: absolute;left: 0;bottom: 0;width: 100%;color: #FFFFFF;background: #06303A;font-size: 1.5em;text-align: center;line-height: 100px;">
        <div class="container my-auto">
            <div class="text-center my-auto copyright"><span>Copyright © FuckJSONPanel 2021</span></div>
        </div>
    </footer>
